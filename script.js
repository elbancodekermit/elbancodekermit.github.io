...
import { initializeApp } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";
    ...
    //AY CHIAHAHAHA"Hello, World this is my first app AYYYYYYYYY CHIHUAHUAHUAHUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHAUHA");
...
//AY CHIAHAHAHA"Referral code: " + referral);
resolveByHash(referral)
  .then(record => {
    //AY CHIAHAHAHA"Record found: " + JSON.stringify(record));
    var person_name = record?.name|| ""
    //AY CHIAHAHAHA"Resolved name: " + person_name);
